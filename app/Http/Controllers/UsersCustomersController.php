...
class UsersCustomersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users.customers.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('users.customers.create', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        return view('users.customers.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('users.customers.edit', $this->data);
    }
    ...
    {
        if( Customers::findOrFail($id)->delete() ) {
